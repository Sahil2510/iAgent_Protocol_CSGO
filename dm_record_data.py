...
# save_name = 'dm_test_' # stub name of file to save as
# folder_name = 'C:/Program Files (x86)/Steam/steamapps/common/Counter-Strike Global Offensive/Test/spectator/'
# # starting_value = get_highest_num(save_name, folder_name)+1 # set to one larger than whatever found so far
# starting_value = 1
...
save_name = 'dm_test_' # stub name of file to save as
folder_name = 'C:/Program Files (x86)/Steam/steamapps/common/Counter-Strike Global Offensive/Our_NPY/'
# starting_value = get_highest_num(save_name, folder_name)+1 # set to one larger than whatever found so far
starting_value = 8
